...
% This version works with the complex .xml files to reporoduce 3D graphs or
% lineages.
% Seems to not be useful for us.
clc
clear all
close all
%% Find Files
...
main_folder = 'C:\Users\al3xm\Documents\_Local_Data\24.09.14_Diffusion_Clippings\Excellent\TOP TIER\TRACKMATED'; % FOR NON-SIMPLE IMPORTS
...
file_path = XML_Paths(1);
G = trackmateGraph( file_path, [], [], true );
% G is a digraph which stores data in the following modialities.
% G.Nodes stores spot data
% G.Edges stores linking data.

% Plot a lineage chart. probably worthless for us.
fig1 = figure();
