...
% %     pattern_folder = uigetdir(spinTIRFData.spinGridCSV.pathname);
% % end
%%___ANM EDIT___WRITE VOLTAGE OUTPUTS TO A SERIES OF SEQUENTIALLY NAMED CSVs IN A USER SELECTED FILE
PATTERN_SAVE_DIRECTORY = uigetdir();
mastervolt=[];
...
writematrix(volt, cat(2, PATTERN_SAVE_DIRECTORY, '/', patternName, '.txt'))
mastervolt = cat(1,mastervolt, volt);
writematrix(mastervolt, cat(2, PATTERN_SAVE_DIRECTORY, '/', '_CONCAT', '.txt'))
%% ___ANM END EDIT__ 
