function [fitCell] = multifits(x,y, shoulders, tophat)
...
for i = -ShoulderRange:ShoulderRange
    ...
    for j = -HatRange:HatRange
        ...
        if (optSSR < bestSSR) & plotImprovements
            bestSSR = optSSR;
...
title(strcat('Optimized Fit.', 'Improvement of ',string(InitSSR-FinalSSR')))
