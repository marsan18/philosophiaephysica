...
%     end
    ...
    msdEnsemble.Properties.Description = 'Ensemble MSD in microns over Tau';
    msdEnsemble.Properties.VariableDescriptions = { 'FileID (key)', ...
                                                    'Time scale, frames', ...
                                                    'Time scale, sec', ... 
                                                    'log10(Ensemble-MSD) over Tau, X (filtered)', ...
                                                    'log10(errmsdX) over Tau, X (filtered)', ...
                                                    'log10(Ensemble-MSD) over Tau, Xo (filtered)', ...
                                                    'log10(errmsdXo) over Tau, Xo (filtered)', ...
                                                    'log10(Ensemble-MSD) over Tau, X (filtered)', ...
                                                    'log10(errmsdX) over Tau, X (filtered)', ...
                                                    'log10(Ensemble-MSD) over Tau, Xo (filtered)', ...
                                                    'log10(errmsdXo) over Tau, Xo (filtered)' };
                                                 
    msdEnsemble.Properties.VariableUnits = {'', 'frames', 's', ...
                                            'log_{10}(um^2)', 'log_{10}(um^2)', ...
                                            'log_{10}(um^2)', 'log_{10}(um^2)', ...
                                            'log_{10}(um^2)', 'log_{10}(um^2)', ...
                                            'log_{10}(um^2)', 'log_{10}(um^2)'};
